...
import os
#================= Config =================#
owner = 7177420250  # ایدی عددی مالک سلف ساز
api_id = 16827053  # ایپی ایدی مالک سلف ساز 
api_hash = "398333f2b7999d2074324ac5dc840483" # ایپی هش مالک سلف ساز
bot_token = "8451599945:AAHV1jLWnn-t4Leck7nv2lzVDgXKQ0vJ-jE" # توکن ربات هلپر 
DBName = "" # نام دیتابیس هلپر 
DBUser = "" # یوزر دیتابیس هلپر 
DBPass = "" # پسورد دیتابیس هلپر 
HELPER_DB_FILE = DBName if DBName else 'helper.sqlite'
#==========================================#

def _sanitize_sql(q):
     q = re.sub(r"\s+LIMIT\s+\d+\b", "", q, flags=re.IGNORECASE)
     q = q.replace("`", "")
     q = re.sub(r"default charset=[^\)\;]+", "", q, flags=re.IGNORECASE)
     return q
